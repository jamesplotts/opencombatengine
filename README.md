...
[![Tests](https://img.shields.io/badge/tests-558%20passing-brightgreen.svg)](tests/)
...
│   └── OpenCombatEngine.GrpcSidecar/    # Layforge's System Engine gRPC contract,
│                                        # implemented against Core/Implementation
├── tests/
│   ├── OpenCombatEngine.Core.Tests/            # Core contract tests
│   ├── OpenCombatEngine.Implementation.Tests/  # Implementation tests
│   └── OpenCombatEngine.GrpcSidecar.Tests/     # Sidecar mapping + RPC tests
├── docs/
